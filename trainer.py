...
class Trainer:
    ...
    def print_model_parameters(self, model: nn.Module) -> None:
        ...
        clip_total, clip_train = count_params(model.latent_diff.cond_stage_model)
        ...
        rows = [
            ...
            ("CLIP", "clip_net", "clip net", clip_total, clip_train),
            (
                "SITS Encoder",
                "sr_sits_enc",
                "task sits encoder",
...
# python trainer.py --config configs_loc/diffsr_maxvit_ltae.yaml --config_file flair-config.yml --exp_name srdiff_maxvit_ltae_ckpt --hparams="diff_net_ckpt=./results/checkpoints/srdiff_maxvit_ltae_ckpt" --infer
